...
class SpinnerColumn(ProgressColumn):
    ...
    def __init__(
        ...
        self.spinner = Loader(spinner_name, style=style, speed=speed)
        self.finished_text = (
    ...
    def set_spinner(
        ...
        Args:
            spinner_name (str): Loader name, see python -m rich.spinner.
            spinner_style (Optional[StyleType], optional): Loader style. Defaults to "progress.spinner".
            speed (float, optional): Speed factor of spinner. Defaults to 1.0.
        """
        self.spinner = Loader(spinner_name, style=spinner_style, speed=speed)
